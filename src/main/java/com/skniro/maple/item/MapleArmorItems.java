...
public class MapleArmorItems {
    ...
    //Armor
    public static final Item Cherry_HELMET = registerItem("cherry_helmet", (new ArmorItem(MapleArmorMaterials.Cherry, EquipmentSlot.HEAD, new Item.Settings())));
    public static final Item Cherry_CHESTPLATE = registerItem("cherry_chestplate", (new ArmorItem(MapleArmorMaterials.Cherry, EquipmentSlot.CHEST, new Item.Settings())));
    public static final Item Cherry_LEGGINGS = registerItem("cherry_leggings", (new ArmorItem(MapleArmorMaterials.Cherry, EquipmentSlot.LEGS, new Item.Settings())));
    public static final Item Cherry_BOOTS = registerItem("cherry_boots", (new ArmorItem(MapleArmorMaterials.Cherry, EquipmentSlot.FEET, new Item.Settings())));
