...
public class MapleOreBlocks {
    public static final Block Salt_Ore =registerBlock("salt_ore",new ExperienceDroppingBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().strength(3.0F, 3.0F), UniformIntProvider.create(3, 7)),Maple.Maple_Group);
