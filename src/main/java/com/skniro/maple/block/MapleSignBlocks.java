...
public class MapleSignBlocks {
    ...
    public static final Block GINKGO_SIGN = registerBlockWithoutItem("ginkgo_sign", new SignBlock(AbstractBlock.Settings.of(Material.WOOD).mapColor(MapleBlocks.GINKGO_LEAVES.getDefaultMapColor()).noCollision().strength(1.0F), MapleSignTypes.GINKGO),Maple.Maple_Group);
    public static final Block GINKGO_WALL_SIGN = registerBlockWithoutItem("ginkgo_wall_sign",new WallSignBlock(AbstractBlock.Settings.of(Material.WOOD).mapColor(MapleBlocks.GINKGO_LEAVES.getDefaultMapColor()).noCollision().strength(1.0F).dropsLike(GINKGO_SIGN),MapleSignTypes.GINKGO),Maple.Maple_Group);
