...
public class MapleBlocks {
   ...
   public static final Block GINKGO_SLAB = registerBlock("ginkgo_slab",
    ...
    public static final Block GINKGO_FENCE_GATE = registerBlock("ginkgo_fence_gate",
            new FenceGateBlock(MapleSignTypes.GINKGO, AbstractBlock.Settings.create().mapColor(GINKGO_PLANKS.getDefaultMapColor()).strength(2.0F, 3.0F)), Maple.Maple_Group);
    ...
    public static final Block CHERRY_FENCE_GATE = registerBlock("cherry_fence_gate",
            new FenceGateBlock(WoodType.CHERRY, AbstractBlock.Settings.create().mapColor(CHERRY_PLANKS.getDefaultMapColor()).strength(2.0F, 3.0F)), Maple.Maple_Group);
    ...
    public static final Block MAPLE_FENCE_GATE = registerBlock("maple_fence_gate",
            new FenceGateBlock(MapleSignTypes.MAPLE, AbstractBlock.Settings.create().mapColor(MAPLE_PLANKS.getDefaultMapColor()).strength(2.0F, 3.0F)), Maple.Maple_Group);
    ...
    public static final Block BAMBOO_FENCE_GATE = registerBlock("bamboo_fence_gate",
            new FenceGateBlock(WoodType.BAMBOO, AbstractBlock.Settings.create().mapColor(BAMBOO_PLANKS.getDefaultMapColor()).strength(2.0f, 3.0f)), Maple.Maple_Group);
    ...
    public static final Block GINKGO_DOOR = registerBlockWithoutItem("ginkgo_door",
            new DoorBlock(MapleBlockSetType.GINKGO, AbstractBlock.Settings.create().mapColor(GINKGO_PLANKS.getDefaultMapColor()).strength(3.0f).sounds(BlockSoundGroup.WOOD).nonOpaque()));
    public static final Block MAPLE_DOOR = registerBlockWithoutItem("maple_door",
            new DoorBlock(BlockSetType.CHERRY, AbstractBlock.Settings.create().mapColor(MAPLE_PLANKS.getDefaultMapColor()).strength(3.0f).sounds(BlockSoundGroup.WOOD).nonOpaque()));
    public static final Block CHERRY_DOOR = registerBlockWithoutItem("cherry_door",
            new DoorBlock(MapleBlockSetType.MAPLE, AbstractBlock.Settings.create().mapColor(CHERRY_PLANKS.getDefaultMapColor()).strength(3.0f).sounds(BlockSoundGroup.WOOD).nonOpaque()));
    public static final Block BAMBOO_DOOR = registerBlockWithoutItem("bamboo_door",
            new DoorBlock(BlockSetType.BAMBOO, AbstractBlock.Settings.create().mapColor(BAMBOO_PLANKS.getDefaultMapColor()).strength(3.0f).sounds(BlockSoundGroup.WOOD).nonOpaque()));

    //TRAPDOOR
    public static final Block GINKGO_TRAPDOOR = registerBlock("ginkgo_trapdoor",
            new TrapdoorBlock(MapleBlockSetType.GINKGO, AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_YELLOW).strength(3.0F).nonOpaque()), Maple.Maple_Group);
    public static final Block CHERRY_TRAPDOOR = registerBlock("cherry_trapdoor",
            new TrapdoorBlock(BlockSetType.CHERRY, AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_PINK).strength(3.0F).nonOpaque()), Maple.Maple_Group);
    public static final Block MAPLE_TRAPDOOR = registerBlock("maple_trapdoor",
            new TrapdoorBlock(MapleBlockSetType.MAPLE, AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_BROWN).strength(3.0F).nonOpaque()), Maple.Maple_Group);
    public static final Block BAMBOO_TRAPDOOR = registerBlock("bamboo_trapdoor",
            new TrapdoorBlock(BlockSetType.BAMBOO, AbstractBlock.Settings.create().mapColor(MapColor.YELLOW).strength(3.0f).nonOpaque()), Maple.Maple_Group);


    //PRESSURE_PLATE
    public static final Block GINKGO_PRESSURE_PLATE = registerBlock("ginkgo_pressure_plate",
            new PressurePlateBlock(MapleBlockSetType.GINKGO, AbstractBlock.Settings.create().mapColor(MapleBlocks.GINKGO_PLANKS.getDefaultMapColor()).noCollision().strength(0.5F).burnable().instrument(NoteBlockInstrument.BASS).pistonBehavior(PistonBehavior.DESTROY)), Maple.Maple_Group);
    public static final Block CHERRY_PRESSURE_PLATE = registerBlock("cherry_pressure_plate",
            new PressurePlateBlock(BlockSetType.CHERRY, AbstractBlock.Settings.create().mapColor(MapleBlocks.CHERRY_PLANKS.getDefaultMapColor()).noCollision().strength(0.5F).burnable().instrument(NoteBlockInstrument.BASS).pistonBehavior(PistonBehavior.DESTROY)), Maple.Maple_Group);
    public static final Block MAPLE_PRESSURE_PLATE = registerBlock("maple_pressure_plate",
            new PressurePlateBlock(MapleBlockSetType.MAPLE, AbstractBlock.Settings.create().mapColor(MapleBlocks.MAPLE_PLANKS.getDefaultMapColor()).noCollision().strength(0.5F).burnable().instrument(NoteBlockInstrument.BASS).pistonBehavior(PistonBehavior.DESTROY)), Maple.Maple_Group);
    public static final Block BAMBOO_PRESSURE_PLATE = registerBlock("bamboo_pressure_plate",
            new PressurePlateBlock(BlockSetType.BAMBOO, AbstractBlock.Settings.create().mapColor(MapleBlocks.BAMBOO_PLANKS.getDefaultMapColor()).noCollision().strength(0.5f).burnable().instrument(NoteBlockInstrument.BASS).pistonBehavior(PistonBehavior.DESTROY)), Maple.Maple_Group);
    //Plants Block
    ...
    public static final Block GREEN_PLASTER =registerBlock("green_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.GREEN_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block PLASTER =registerBlock("plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block ORANGE_PLASTER =registerBlock("orange_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.ORANGE_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block MAGENTA_PLASTER =registerBlock("magenta_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.MAGENTA_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block LIGHT_BLUE_PLASTER =registerBlock("light_blue_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.LIGHT_BLUE_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block YELLOW_PLASTER =registerBlock("yellow_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.YELLOW_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block LIME_PLASTER =registerBlock("lime_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.LIME_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block PINK_PLASTER =registerBlock("pink_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.PINK_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block GRAY_PLASTER =registerBlock("gray_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.GRAY_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block LIGHT_GRAY_PLASTER =registerBlock("light_gray_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.LIGHT_GRAY_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block CYAN_PLASTER =registerBlock("cyan_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.CYAN_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block PURPLE_PLASTER =registerBlock("purple_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.PURPLE_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block BLUE_PLASTER =registerBlock("blue_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.BLUE_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block BROWN_PLASTER =registerBlock("brown_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.BROWN_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
    public static final Block RED_PLASTER =registerBlock("red_plaster",
            new Block(AbstractBlock.Settings.copy(Blocks.RED_CONCRETE).requiresTool().strength(1.8F)),Maple.Maple_Group);
