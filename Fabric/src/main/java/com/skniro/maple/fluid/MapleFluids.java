    ...
    public class MapleFluids {
        ...
        public static void registerFluids() {
            STILL_Hot_Spring = Registry.register(BuiltInRegistries.FLUID,
                    Identifier.fromNamespaceAndPath(Maple.MOD_ID, "hot_spring"), new MapleHotSpringFluid.Still());

            FLOWING_Hot_Spring = Registry.register(BuiltInRegistries.FLUID,
                    Identifier.fromNamespaceAndPath(Maple.MOD_ID, "flowing_hot_spring_water"), new MapleHotSpringFluid.Flowing());
        }
    }
