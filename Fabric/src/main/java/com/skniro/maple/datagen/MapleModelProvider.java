...
public class MapleModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerators itemModelGenerator) {
        ...
        //Cherry armors
        itemModelGenerator.generateTrimmableItem(MapleArmorItems.Cherry_HELMET, MapleEquipmentAssetKeys.Cherry, TRIM_PREFIX_HELMET, false);
        itemModelGenerator.generateTrimmableItem(MapleArmorItems.Cherry_CHESTPLATE, MapleEquipmentAssetKeys.Cherry, TRIM_PREFIX_CHESTPLATE, false);
        itemModelGenerator.generateTrimmableItem(MapleArmorItems.Cherry_LEGGINGS, MapleEquipmentAssetKeys.Cherry, TRIM_PREFIX_LEGGINGS, false);
        itemModelGenerator.generateTrimmableItem(MapleArmorItems.Cherry_BOOTS, MapleEquipmentAssetKeys.Cherry, TRIM_PREFIX_BOOTS, false);
