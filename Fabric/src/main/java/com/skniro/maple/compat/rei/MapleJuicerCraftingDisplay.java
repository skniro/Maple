...
public class MapleJuicerCraftingDisplay extends BasicDisplay {
    public MapleJuicerCraftingDisplay(List<EntryIngredient> inputs, List<EntryIngredient> outputs, Optional<Identifier> location) {
        super(inputs, outputs, location);
    }
    public MapleJuicerCraftingDisplay(@Nullable RecipeEntry<MapleJuicerCraftingRecipe> recipe) {
