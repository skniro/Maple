...
public class MapleScreenHandlerType<T extends AbstractContainerMenu>{
    public static final MenuType<MapleJuicerBlockScreenHandler> Maple_JUICER =
            Registry.register(BuiltInRegistries.MENU, Identifier.fromNamespaceAndPath(Maple.MOD_ID, "maple_juicer_screen_handler"),
                    new ExtendedMenuType<>(MapleJuicerBlockScreenHandler::new, BlockPos.STREAM_CODEC));
