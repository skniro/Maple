...
public interface MapleRecipeType<T extends Recipe<?>> {
    ...
    public static final Supplier<RecipeSerializer<MapleJuicerCraftingRecipe>> Maple_JUIER_SERIALIZER = SERIALIZERS.register( "maple_juicer", ()-> MapleJuicerCraftingRecipe.SERIALIZER);
