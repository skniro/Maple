...
public class MapleItemTagGeneration extends FabricTagProvider<Item> {
    ...
    public class ModItemTags {
        public static final TagKey<Item> C_SAPLING = TagKey.create(Registries.ITEM, new ResourceLocation("c", "saplings"));
        public static final TagKey<Item> C_MAPLE_LOGS = TagKey.create(Registries.ITEM, new ResourceLocation("c", "maple_logs"));
        public static final TagKey<Item> C_CHERRY_LOGS = TagKey.create(Registries.ITEM, new ResourceLocation("c", "cherry_logs"));
    }
