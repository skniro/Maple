...
public class MapleParticleTypes {
    ...
    static {
        Registry.register(BuiltInRegistries.PARTICLE_TYPE, new ResourceLocation(Maple.MOD_ID,"cherry_leaves"), CHERRY_LEAVES);
        Registry.register(BuiltInRegistries.PARTICLE_TYPE, new ResourceLocation(Maple.MOD_ID,"sakura_leaves"), SAKURA_LEAVES);
        Registry.register(BuiltInRegistries.PARTICLE_TYPE, new ResourceLocation(Maple.MOD_ID,"hot_spring"), HOT_SPRING);
    }
