...
public class MapleContent {
    ...
    public static void datafix(final @NotNull ModContainer mod) {
        ...
        Schema schemaV1 = builder.addSchema(3, NamespacedSchema::new);
        SimpleFixes.addItemRenameFix(builder, "Rename old_item to new_item",
                new ResourceLocation(Maple.MOD_ID, "cherry_log"), new ResourceLocation(Maple.MOD_ID, "cherry_log"), schemaV1);
