...
public class Maple implements ModInitializer, TerraBlenderApi {
    ...
    public static final ResourceKey<CreativeModeTab> Maple_Group = ResourceKey.create(Registries.CREATIVE_MODE_TAB, new ResourceLocation(MOD_ID, "maple_group"));
    public static final ResourceKey<CreativeModeTab> Maple_Group_Food = ResourceKey.create(Registries.CREATIVE_MODE_TAB, new ResourceLocation(MOD_ID, "test_group"));
    public static final ResourceKey<CreativeModeTab> Maple_Group_Furniture = ResourceKey.create(Registries.CREATIVE_MODE_TAB, new ResourceLocation(MOD_ID, "maple_group_furniture"));
    ...
    public void onTerraBlenderInitialized() {
        Regions.register(new MapleGroveBiome(new ResourceLocation(Maple.MOD_ID, "overworld_1"), 2));
        Regions.register(new MapleSakuraBiome(new ResourceLocation(Maple.MOD_ID, "overworld_2"), 2));
    }
