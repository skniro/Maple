...
public class MapleArmorItems {
    ...
    //Tool
    public static final Item Cherry_SWORD = registerItem("cherry_sword", (new SwordItem(MapleToolMaterials.Cherry, 3, -2.4F, new Item.Properties())));
    public static final Item Cherry_SHOVEL = registerItem("cherry_shovel", (new ShovelItem(MapleToolMaterials.Cherry, 1.5F, -3.0F, new Item.Properties())));
    public static final Item Cherry_PICKAXE = registerItem("cherry_pickaxe", (new MaplePickaxeItem(MapleToolMaterials.Cherry, 1, -2.8F, new Item.Properties())));
    public static final Item Cherry_AXE = registerItem("cherry_axe", (new MapleAxeItem(MapleToolMaterials.Cherry, 5.0F, -3.0F, new Item.Properties())));
    public static final Item Cherry_HOE = registerItem("cherry_hoe", (new MapleHoeItem(MapleToolMaterials.Cherry, -3, 0.0F, new Item.Properties())));
