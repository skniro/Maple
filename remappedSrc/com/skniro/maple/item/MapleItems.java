...
public class MapleItems {
    public static final Item CHERRY_SIGN = registerItem("cherry_sign",
            new SignItem(new FabricItemSettings().stacksTo(16),
    ...
    public static final Item GINKGO_HANGING_SIGN = registerItem("ginkgo_hanging_sign", new HangingSignItem(
            MapleSignBlocks.GINKGO_HANGING_SIGN, MapleSignBlocks.GINKGO_WALL_HANGING_SIGN, new FabricItemSettings().stacksTo(16)));
    public static final Item Maple_HANGING_SIGN = registerItem("maple_hanging_sign", new HangingSignItem(
            MapleSignBlocks.Maple_HANGING_SIGN, MapleSignBlocks.Maple_WALL_HANGING_SIGN, new FabricItemSettings().stacksTo(16)));

    public static final Item CHERRY_DOOR = registerItem("cherry_door",new DoubleHighBlockItem(MapleBlocks.CHERRY_DOOR, new FabricItemSettings().stacksTo(16)));
    public static final Item MAPLE_DOOR = registerItem("maple_door",new DoubleHighBlockItem(MapleBlocks.MAPLE_DOOR, new FabricItemSettings().stacksTo(16)));
    public static final Item BAMBOO_DOOR = registerItem("bamboo_door",new DoubleHighBlockItem(MapleBlocks.BAMBOO_DOOR, new FabricItemSettings().stacksTo(16)));
    public static final Item GINKGO_DOOR = registerItem("ginkgo_door",new DoubleHighBlockItem(MapleBlocks.GINKGO_DOOR, new FabricItemSettings().stacksTo(16)));
    //Food Materials
    ...
    //Seed
    public static final Item Rice = registerItem("rice",new ItemNameBlockItem(MapleBlocks.RICE, (new FabricItemSettings())));
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(Maple.MOD_ID, name), item);
    }
