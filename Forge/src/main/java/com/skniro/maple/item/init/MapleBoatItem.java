...
public class MapleBoatItem extends Item {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
    private final MapleBoatEntity.Type type;
    private final boolean hasChest;
    public MapleBoatItem(boolean pHasChest, MapleBoatEntity.Type pType, Item.Properties pProperties) {
        super(pProperties);
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                ...
                if(boat instanceof MapleChestBoatEntity chestBoat) {
                    ...
                    ((MapleBoatEntity)boat).setVariant(this.type);
                }
