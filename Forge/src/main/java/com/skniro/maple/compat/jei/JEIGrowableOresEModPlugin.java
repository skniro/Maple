...
public class JEIGrowableOresEModPlugin implements IModPlugin {
    ...
    public ResourceLocation getPluginUid() {
        return ResourceLocation.tryBuild(Maple.MODID, "jei_plugin");
    }
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        List<MapleJuicerCraftingRecipe> craftingRecipes = recipeManager.getAllRecipesFor(MapleRecipeType.Maple_JUIER_TYPE.get()).stream().map(RecipeHolder::value).toList();
